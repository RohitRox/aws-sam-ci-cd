...
The `x-amazon-apigateway-integration` can be configured to have various kinds of checks and validations so that invalid requests can be aborted beforehand before triggering lambda.
